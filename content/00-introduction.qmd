...
+==============+======================+=================+==========================+
| 1            | 0: Introduction quiz | 2 January 2025  | 3 January 2025, 11:59PM  |
+--------------+----------------------+-----------------+--------------------------+
| 2            | 1: X quiz            | 6 January 2025  | 10 January 2025, 11:59PM |
|              |                      |                 |                          |
|              | 2: X quiz            |                 |                          |
|              |                      |                 |                          |
|              | 3: X quiz            |                 |                          |
+--------------+----------------------+-----------------+--------------------------+
| 3            | 4: X quiz            | 13 January 2025 | 17 January 2025, 11:59PM |
|              |                      |                 |                          |
|              | 5: X quiz            |                 |                          |
|              |                      |                 |                          |
|              | 6: X quiz            |                 |                          |
...
<iframe src="https://umd.hosted.panopto.com/Panopto/Pages/Embed.aspx?id=86d7d676-961d-4379-be9c-b24300bb7137&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&start=0&interactivity=all" height="600px" width="100%" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="Introduction to R and RStudio" ></iframe>

## Slides

<iframe class="slide-deck" src="../content/slides/00-01-intro_to_r_rstudio.html" width="100%" height="600px">
...
<iframe src="https://umd.hosted.panopto.com/Panopto/Pages/Embed.aspx?id=16ee65c7-1484-4bee-9a75-b24300c0fc5a&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&start=0&interactivity=all" height="600px" width="100%" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="Tour of RStudio" ></iframe>
